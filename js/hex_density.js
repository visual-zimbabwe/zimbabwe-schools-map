...
function renderLayer(geojson) {
  ...
  geoLayer = L.geoJSON(geojson, {
    ...
    onEachFeature: (feature, layer) => {
      ...
      layer.bindTooltip(
        `<strong>Hex cell</strong><br/>Share: ${pct}%<br/>Total: ${total}<br/>Primary: ${primary}<br/>Secondary: ${secondary}`,
...
fetch("data/zw_hex_density.geojson")
  ...
  .catch((err) => {
    console.error("Failed to load hex density:", err);
  });
